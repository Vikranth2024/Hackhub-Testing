...
import FileStorage from "../../../backend/artifacts/contracts/FileStorage.sol/FileStorage.json";
...
const Dashboard = () => {
    ...
    const RPC_URL = config.REACT_APP_RPC_URL;
    const CONTRACT_ADDRESS = config.REACT_APP_CONTRACT_ADDRESS;
    const CHAIN_ID = config.REACT_APP_CHAIN_ID;
